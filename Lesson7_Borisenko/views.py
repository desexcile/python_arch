...
from patterns.excile_creation_patterns import Engine, Logger, MapperRegistry
...
from patterns.excile_arch_patterns import UnitOfWork
...
class PreMinersListView(ListView):
    ...
    def get_queryset(self):
        ...
        result = mapper.all()
        for preminer in result:
            for course in site.courses:
                for course_preminers in course.preminers:
                    if course_preminers.id == preminer.id:
                        preminer.courses.append(course)
        return result
